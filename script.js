...
(function () {
  ...
  var DICT = {
    es: {
      ...
      'method.note': 'Cuatro pasos, unos días y cero riesgo: no pagas nada hasta ver tu web terminada. Del resto me encargo yo.',
      'method.cta': 'Empezar por WhatsApp',
      'step1.t': 'Hablamos',
      'step1.d': 'Me cuentas tu negocio por WhatsApp: qué haces, a quién te diriges y qué necesitas. Te respondo en menos de 24 horas.',
      'step2.t': 'Diseño tu demo',
      'step2.d': 'Creo una demo real de tu web, sin coste. La ves funcionando y decides con ella delante, no sobre promesas.',
      'step3.t': 'La publicamos',
      'step3.d': 'Cuando te convence, la dejo online en pocos días: rápida, segura y lista para recibir clientes.',
      'step4.t': 'Yo me encargo del resto',
      'step4.d': 'Hosting, seguridad, cambios y visibilidad en buscadores para que te encuentren. Tú te centras en tu negocio.',
    ...
    en: {
      ...
      'method.note': 'Four steps, a few days, zero risk: you pay nothing until your website is finished in front of you. I handle the rest.',
      'method.cta': 'Start on WhatsApp',
      'step1.t': 'We talk',
      'step1.d': 'You tell me about your business on WhatsApp — what you do, who you serve and what you need. I reply within 24 hours.',
      'step2.t': 'I design your demo',
      'step2.d': 'I build a real demo of your website, free. You see it working and decide with it in front of you, not on promises.',
      'step3.t': 'We go live',
      'step3.d': 'Once you are convinced, I put it online in a few days: fast, secure and ready to bring in customers.',
      'step4.t': 'I handle the rest',
      'step4.d': 'Hosting, security, changes and search visibility so people find you. You focus on your business.',
